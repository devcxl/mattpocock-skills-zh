...
- **[wayfinder](./wayfinder/SKILL.md)** — 规划一大块工作——超过一次 agent 会话能容纳的体量——以共享的调查 ticket 地图形式呈现，逐个解决，直到路线清晰。
...
- **[implement](./implement/SKILL.md)** — 根据 spec 或一组 tickets 描述的内容实现工作，在预先约定的 seam 处驱动 `/tdd`，提交前以 `/code-review` 收尾。
